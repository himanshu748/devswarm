...
- dashboards/: four dashboards (Command Center, Generation Overview, LLM Economics, Review-Gate Funnel). Start with Command Center. POST each to /api/v1/dashboards, or paste into the SigNoz dashboard import UI.
